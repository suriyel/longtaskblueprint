---
name: gate_srs
description: SRS 硬门 — 脚本门禁 review skill：运行 gate_srs.cjs 校验产物，并按 OK/FAIL/BLOCKED 三态回报框架。
---

# SRS 硬门

<!-- gate-wrapper: shared-scripts/gate_srs.cjs -->
## 门禁校验（本节点唯一职责）
1. 运行校验脚本：`node {{SCRIPTS}}/gate_srs.cjs`。
